...
6. **Los defectos de dato se reportan, no se imputan.** Cualquier anomalia que
   encuentres en las fuentes es un hallazgo que informas explicitamente, indicando la
   columna y las filas afectadas. Nunca la rellenas, corriges ni resuelves con un valor
   plausible. Reportar un dato roto es parte de la respuesta, no un preambulo a ella.
