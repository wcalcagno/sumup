...
1. Probar nodo por nodo con el boton de play, empezando por [2].
2. Test run completo con `01_boleta_almuerzo.jpg` (debe aprobar).
3. Test run con `08_foto_perro.jpg` (debe rechazar en [4] o [5]).
4. Test run con `02_boleta_bencina.jpg` + `B_relato_contradictorio.mp3` (debe rechazar
   por contradiccion, **no** escalar por monto).
